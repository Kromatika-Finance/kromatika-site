...
const faqs = [
	...
	},
	{
		...
		content: (
			<>
				...
				price. Fixed, as in not depending on your amount traded. We refer to our&nbsp;
	...
	},
	{
		...
		content: [
			'Kromatika requires a fee to cover the cost of the trade processor (ChainLink Keepers). When a trade is processed $KROM is deducted from the protocol user’s balance on the dapp and sent to the trade processor to cover the gas cost. Hence, the $KROM tokens are circulating: Uniswap -> User -> Kromatika DEX -> Uniswap.',
		],
	},
	{
		...
		content: (
			<>
				...
				&nbsp; under the MIT and GPL-3.0 license. Anybody can see how it was developed,
				built and who are the code contributors. Developers are encouraged to
				submit a PR if they are willing to contribute.
			</>
		),
	},
];
