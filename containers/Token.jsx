      ...
      <div className="token">
        ...
        <div className="token__content">
          ...
          <p>
            ...
            KROM tokens, you not only get access to cost efficient limit orders
            on the DEX, but you will also get LP fees on every trade thanks to
            the innovative approach to providing liquidity.
            <br />
            <br />
        ...
        >
          ...
          <div className="card__overlay">
            ...
            <span className="card__content">
              ...
              <p>
                7 million $KROM tokens are held in a multisignature Gnosis Safe
                wallet.
              </p>
            </span>
          </div>
