		...
		<footer className='footer'>
			<div className='footer-wide-screen'>
				...
				<div className='copyright'>
					...
					<p>Kromatika.Finance is brought to you by {' '}
						<Link
							href='https://ipfs.fleek.co/ipfs/QmVkBaizhwHoCEfhFRGFCepuFq6KnyP7LFxeVVKxPXaDLa?filename=CERTIFICATE%20OF%20INCORPORATION.pdf'
						>
							<a
								target='_blank'
								rel='noopener noreferrer'>
					...
					<p>(Reg. no: 115317), Marshall Islands</p>
				</div>
			</div>
